...
export const apps: AppProgress[] = [
  ...
  },
  {
    ...
    progress: 80,
    month: '2026-06',
    summary: '记录喂养、作息与成长点滴，支持家庭成员协作与提醒。微信小程序审核推进中。',
  ...
  },
  {
    ...
    progress: 90,
    month: '2026-06',
    website: 'https://nightingalevoicechanger.anxiqing.cn',
    summary: '录音变声、音色库、历史同步与会员订阅。Android APK 已开放下载，App Store 筹备中。',
